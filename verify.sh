...
verify_check "docker-cli" "false" "system" "docker --version"
verify_check "docker-daemon" "false" "system" "docker info --format 'Docker daemon {{.ServerVersion}}'"
verify_check "colima"     "false" "system" "colima --version"
